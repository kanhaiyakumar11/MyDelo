...
<RxCross2 className='w-[30px] h-[30px] text-green-400 text-[18px] font-semibold cursor-pointer hover:text-gray-600' onClick={()=>setShowCart(false)}/>
  ...
  <h2 class="text-2xl font-semibold mb-6 text-center text-green-400">Add Address</h2>
  <form class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="flex flex-col">
      <label for="mobile" class="mb-2 font-medium text-gray-700">Mobile</label>
      <input type="number" id="mobile" placeholder="Enter Phone Number"
        class="px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" />
    </div>

    <div class="flex flex-col md:col-span-2">
      <label for="address" class="mb-2 font-medium text-gray-700">Address</label>
      <textarea id="address" rows="4" placeholder="Enter Address here"
        class="px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"></textarea>
    </div>
  </form>
</div>
